defmodule GithubTest do
  ...
  test "repo URL building is done properly for string owner and repo names" do
    assert Github.repo_url("mike-north", "elixir-fundamentals-workshop") === "https://api.github.com/repos/mike-north/elixir-fundamentals-workshop?access_token=22ba634a0d3280f10c9245b6eb49b5800f6b3b29"
  end
